...
输出 `src-tauri/target/release/modudesk.exe` 及 `src-tauri/target/release/bundle/nsis/ModuDesk_0.3.2_x64-setup.exe`。当前只生成 NSIS 安装包，未代码签名。
